...
public class WaxedOxidizedIronGolemEntityRenderer extends MobEntityRenderer<IronGolemEntity, IronGolemEntityRenderState, IronGolemEntityModel> {
    private static final Identifier TEXTURE = Identifier.of("rust", "textures/entity/waxed_oxidized_iron_golem.png");

    public WaxedOxidizedIronGolemEntityRenderer(EntityRendererFactory.Context context) {
