...
public class WaxedWeatheredIronGolemEntityRenderer extends MobEntityRenderer<IronGolemEntity, IronGolemEntityRenderState, IronGolemEntityModel> {
    private static final Identifier TEXTURE = Identifier.of("rust", "textures/entity/waxed_weathered_iron_golem.png");

    public WaxedWeatheredIronGolemEntityRenderer(EntityRendererFactory.Context context) {
