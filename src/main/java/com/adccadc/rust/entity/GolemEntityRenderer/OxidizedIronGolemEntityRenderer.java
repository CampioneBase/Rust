...
public class OxidizedIronGolemEntityRenderer extends MobEntityRenderer<IronGolemEntity, IronGolemEntityRenderState, IronGolemEntityModel> {
    private static final Identifier TEXTURE = Identifier.of("rust", "textures/entity/oxidized_iron_golem.png");

    public OxidizedIronGolemEntityRenderer(EntityRendererFactory.Context context) {
